...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_REWINDER                        = _UxGT("Re-Winder");  //rewinder
  PROGMEM Language_Str MSG_REWINDER_BLANK                  = _UxGT("                   ");  
  PROGMEM Language_Str MSG_REWINDER_LINE                   = _UxGT("___________________");
  PROGMEM Language_Str MSG_REWINDER_PROBE                  = _UxGT("1. Check Spool Size");
  PROGMEM Language_Str MSG_REWINDER_TENSION                = _UxGT("2. Tension Spool");
  PROGMEM Language_Str MSG_REWINDER_TEST                   = _UxGT("3. Trial Wind 3 ROWS");
  PROGMEM Language_Str MSG_REWINDER_REWIND                 = _UxGT("4. Start Full Wind");
  PROGMEM Language_Str MSG_REWINDER_INDEXCAL               = _UxGT("   Calibrate Indexer");
  PROGMEM Language_Str MSG_REWINDER_WINDERCAL              = _UxGT("   Calibrate Winder");
  PROGMEM Language_Str MSG_REWINDER_STATUS                 = _UxGT("Winder running...");
  PROGMEM Language_Str MSG_REWINDER_FINISHED               = _UxGT("Winder complete");
  PROGMEM Language_Str MSG_REWINDER_RELEASE                = _UxGT("Release spool");
  PROGMEM Language_Str MSG_REWINDER_KILL                   = _UxGT("## EMERGENCY STOP ##");
  PROGMEM Language_Str MSG_REWINDER_1SLOW                  = _UxGT("1.5 revs slow speed");
  PROGMEM Language_Str MSG_REWINDER_5REGULAR               = _UxGT("5 revs regular speed");
  PROGMEM Language_Str MSG_REWINDER_2FAST                  = _UxGT("2 revs fast speed");
  PROGMEM Language_Str MSG_REWINDER_FILAMENT               = _UxGT("Please Load Filament");
  PROGMEM Language_Str MSG_REWINDER_SPEED                  = _UxGT("Winding Speed");
