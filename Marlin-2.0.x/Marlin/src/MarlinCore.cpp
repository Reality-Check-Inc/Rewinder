...
PGMSTR(G1_WINDER, "M810 G1 X%d E%d\nM811 G1 X%d E%d\nM812 G1 F%d"); //rewinder
PGMSTR(G1_WINDER_SPEED, "M812 G1 F%d"); //rewinder
...
void idle(TERN_(ADVANCED_PAUSE_FEATURE, bool no_stepper_sleep/*=false*/)) {
  ...
  if (READ(19 ) && (planner.movesplanned() || printingIsActive())){    //rewinder
    ...
    // NOMORE(duration, 5000U);
      ...
      SERIAL_ECHOLN("Wham Bam we ranout of filament!");
